...
const Footer = () => {
    return (
        <div>
            <footer className="footer items-center p-2 bg-gray-50 text-gray-900 mt-20 mb-2 shadow-xl rounded-xl">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 - All right reserved to Fahmidur Rahman Arnob</p>
                </div>
            </footer>
        </div>
    );
